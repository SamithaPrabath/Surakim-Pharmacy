...
public class ConsumableItems extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Consumble Items");
        jLabel1.setToolTipText("");
        jPanel3.add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(250, 10, 390, -1));
        ...
        inventoryStockTable.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Stock ID", "Item Name", "Available Qty", "Added Date", "Price", "Refferd By"
            }
        ) {
        ...
        jPanel3.add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 150, 730, 230));
        ...
        jPanel3.add(nameLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 400, 130, 30));
        ...
        jPanel3.add(name, new org.netbeans.lib.awtextra.AbsoluteConstraints(180, 400, 310, 30));

        jLabel6.setFont(new java.awt.Font("Tahoma", 0, 18)); // NOI18N
        jLabel6.setText("Quantity");
        jPanel3.add(jLabel6, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 480, 140, 20));
        ...
        jPanel3.add(quantity, new org.netbeans.lib.awtextra.AbsoluteConstraints(180, 480, 310, 30));
        ...
        jPanel3.add(updateBtn, new org.netbeans.lib.awtextra.AbsoluteConstraints(580, 430, 110, 40));
        ...
        jPanel3.add(clearBtn, new org.netbeans.lib.awtextra.AbsoluteConstraints(580, 480, 110, 40));
        ...
        jPanel3.add(deleteBtn, new org.netbeans.lib.awtextra.AbsoluteConstraints(580, 540, 110, 40));
        ...
        jPanel3.add(jButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(580, 590, 110, 40));
        ...
        jPanel3.add(price, new org.netbeans.lib.awtextra.AbsoluteConstraints(180, 520, 310, 30));

        nameLabel3.setFont(new java.awt.Font("Tahoma", 0, 18)); // NOI18N
        nameLabel3.setText("Price");
        jPanel3.add(nameLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 520, 130, 30));

        nameLabel4.setFont(new java.awt.Font("Tahoma", 0, 18)); // NOI18N
        nameLabel4.setText("Reffered By");
        jPanel3.add(nameLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 620, 130, 30));
        ...
        jPanel3.add(reffered, new org.netbeans.lib.awtextra.AbsoluteConstraints(180, 620, 310, 30));

        nameLabel5.setFont(new java.awt.Font("Tahoma", 0, 18)); // NOI18N
        nameLabel5.setText("Available Quantity");
        jPanel3.add(nameLabel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 440, -1, 30));
        ...
        jPanel3.add(availble, new org.netbeans.lib.awtextra.AbsoluteConstraints(180, 440, 310, 30));

        jLabel5.setText("Item Name");
        jPanel3.add(jLabel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(70, 110, -1, -1));
        jPanel3.add(iName, new org.netbeans.lib.awtextra.AbsoluteConstraints(140, 100, 190, -1));
        ...
        jPanel3.add(jButton3, new org.netbeans.lib.awtextra.AbsoluteConstraints(360, 100, -1, -1));

        jLabel7.setFont(new java.awt.Font("Tahoma", 0, 18)); // NOI18N
        jLabel7.setText("Amount(RS.)");
        jPanel3.add(jLabel7, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 570, -1, -1));

        amount.setEditable(false);
        amount.setFont(new java.awt.Font("Tahoma", 0, 18)); // NOI18N
        jPanel3.add(amount, new org.netbeans.lib.awtextra.AbsoluteConstraints(180, 560, 310, 30));
    ...
    public void showTableContents(){
        ...
        try {
            ...
            for(int i=0;rs.next();i++){
                row[0]=rs.getString("iSID");
                row[1]=rs.getString("iSName");    
                row[2]=rs.getString("iSQTy");
                row[3]=rs.getString("iSDate");
                row[4]=rs.getString("price");
                row[5]=rs.getString("refferd_by");
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        if(!iName.getText().equals("")){
            ...
            try {
                Connection con=DriverManager.getConnection("jdbc:mysql://localhost:3306/surakim_db","root","");
                Statement st=con.createStatement();
                String query="select * from inventory_stock where iSName like '%"+iName.getText()+"%' and item_type='Consumable Items';";
                ResultSet rs=st.executeQuery(query);
                for(int i=0;rs.next();i++){
                    row[0]=rs.getString("iSID");
                    row[1]=rs.getString("iSName");
                    row[2]=rs.getString("item_type");
                    row[3]=rs.getString("iSQTy");
                    row[4]=rs.getString("iSDate");
                    row[5]=rs.getString("price");
                    row[6]=rs.getString("refferd_by");
